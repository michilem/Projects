...
class Central:
    ...
    def detect_blob(self, image):
        ...
        if keypoints!=[]:
            ...
            self.blobPubX.publish(keypoints[0].pt[0])
            self.blobPubY.publish(keypoints[0].pt[1])
    ...
    def central_execute(self):
        ...
        self.blobPubX = rospy.Publisher("blob_position/x",Float64,queue_size=10)
        self.blobPubY = rospy.Publisher("blob_position/y",Float64,queue_size=10)
